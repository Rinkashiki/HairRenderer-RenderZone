...
void BloomPass::setup_shader_passes() {
    ...
    ComputeShaderPass* downsamplePass =
        new ComputeShaderPass(m_device->get_handle(), get_engine_resources_path() + "shaders/compute/downsample.glsl");
    ...
    ComputeShaderPass* upsamplePass =
        new ComputeShaderPass(m_device->get_handle(), get_engine_resources_path() + "shaders/compute/upsample.glsl");
    ...
    GraphicShaderPass* bloomPass = new GraphicShaderPass(
        m_device->get_handle(), m_renderpass, m_imageExtent, get_engine_resources_path() + "shaders/misc/bloom.glsl");
